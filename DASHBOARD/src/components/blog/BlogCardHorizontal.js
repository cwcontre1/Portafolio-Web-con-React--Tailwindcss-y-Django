                  ...
                  <div className="lg:absolute lg:top-28">
                      {
                        ...
                        <>
                        <span className=" rounded-full p-1 px-2 bg-green-200 text-green-700  mx-1 font-medium text-sm ">Publicado</span> <span className="text-gray-300">&middot;</span> 
                        </>
                        :
                        <>
                        <span className=" rounded-full p-1 px-2 bg-rose-200 text-rose-700  mx-1 font-mediu text-sm ">Borrador</span> <span className="text-gray-300">&middot;</span> 
                        </>
                      ...
                      <span className="mt-2 mx-2 font-medium text-gray-800 text-sm">{data.time_read} min lect</span> 
                      {
                        data.description ?
