...
function EditPost({
    ...
    return(
        <Layout>
            <Helmet>
                {/* <!-- Primary Meta Tags --> */}
                <title>KoiDevs | Admin Blog</title>
            ...
            </Helmet>
        {
            ...
            <div className=" px-4 py-5 sm:px-6">
                <div className="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                    ...
                    <h3 className="text-3xl font-medium leading-6 text-gray-900">Editor de Posts</h3>
            ...
            <div className="mt-5 border-t border-gray-200">
                    ...
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            ...
                            <form onSubmit={e=>onSubmit(e)} className="flex w-full">
                                ...
                                <span className="ml-4 flex-shrink-0">
                                    <button
                                    type="submit"
                                    className="rounded-md mr-2 bg-white font-medium text-[#ff561e] hover:text-orange-500"
                                    >
                                    Guardar
                                    </button>
                                    <div
                                    onClick={()=>setUpdateTitle(false)}
                                    className="cursor-pointer inline-flex rounded-md bg-white font-medium text-[#ff561e] hover:text-orange-500"
                                    >
                                    Cancelar
                                    </div>
                                </span>
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-gray-500">Slug (corto y todo unido, sin simbolos)</dt>
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            updateSlug ?
                            <>
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-gray-500">Fondo (imagenes oscuras ocultan el post)</dt>
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            updateThumbnail ?
                            <>
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-gray-500">Descripcion principal</dt>
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            updateDescription ?
                            <>
                    ...
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            ...
                            <>
                                <span className="flex-grow text-lg">
                                    {
                                        post.content ?
                                        <div className="prose prose-lg max-w-6xl prose-orange mx-auto mt-6 text-gray-500">
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-gray-500">Tiempo de lectura (en minutos)</dt>
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            updateTime ?
                            <>
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-gray-500">Categoría</dt>
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            updateCategory ?
                            <>
                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                        ...
                        <div className="mt-3 text-center sm:mt-5">
                            ...
                            {
                                post.get_status === 'published' ?
                                <span>Pasar este Post a borrador?</span>
                                :
                            ...
                            <div className="mt-2">
                            {
                                ...
                                <p className="text-sm text-gray-500">
                                    Para publicar este post debes registrar: Título, Descripcion, Slug y Contenido
                                </p>
                            ...
                            <>
                            
                                {
                                    ...
                                    <form onSubmit={e=>onSubmitDraft(e)} className="mt-5 sm:mt-6">
                                            <button
                                                type="submit"
                                                className="inline-flex w-full justify-center rounded-md border border-transparent bg-[#ff561e] px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 sm:text-sm"
            ...
            <Dialog as="div" className="relative z-10" onClose={setOpenDelete}>
                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                        ...
                        <div className="mt-3 text-center sm:mt-5">
                            <Dialog.Title as="h3" className="text-lg font-medium leading-6 text-gray-900">
                            <span>Borrar el Post</span>
                            </Dialog.Title>
                            <div className="mt-2">
                            
                                <p className="text-sm text-gray-500">
                                    Segur@ deseas eliminar este post?
                                </p>
                            </div>
                        </div>
                        </div>
        ...
        <div className="relative isolate overflow-hidden bg-gray-100 px-6 pt-16 shadow-xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="text-3xl font-bold tracking-tight text-footer-color sm:text-4xl">
              Ya casi!
              <br />
              Me toma unos segundos cargar esta sección.
            </h2>
