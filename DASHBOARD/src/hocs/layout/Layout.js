    ...
    return(
        ...
        */}
        <div>
            ...
            <div className="flex min-h-0 flex-1 flex-col  shadow-card  bg-gray-50">
                ...
                <button onClick={e=>setOpen(true)} className="group block w-full flex-shrink-0">
                    ...
                    <div className="ml-3">
                        ...
                        <p className="text-xs font-medium text-gray-500 group-hover:text-gray-700">Desconectarse</p>
                    </div>
                    </div>
                </button>
                </div>
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                    ...
                    <div className="mt-3 text-center sm:mt-5">
                        ...
                        <p className="text-sm text-gray-500">
                            Gracias por contribuir a mi portafolio! &#60;3
                        </p>
                        </div>
                    </div>
                    </div>
